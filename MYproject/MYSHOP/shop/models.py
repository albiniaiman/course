...
class Book(models.Model):
    ...
    photo = models.ImageField(help_text='Select photo of the book', default='default.jpg')
    quantity = models.IntegerField(default=0, help_text="Enter number of physical objects")
